...
If your Box account is controlled by an organization, e.g. you use Box at work, Box apps may be controlled by your Box-admin team. If this is the case, you might refer them to this article as a part of a request to have an app created.
...
2. Use a server-app, as described in [this article](./boxr-app-service.html).
...
Having logged into your account, start at the [Box Developers Console](https://app.box.com/developers/console).
...
![Four steps](figures/four_steps.png){width=100%}
...
This is where you can find `client_id` and `client_secret`, which you will need to use `box_auth()`.

![Set Redirect URI](figures/redirect_uri.png){width=100%}
